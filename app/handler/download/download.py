...
def get_dataset_and_settings(levtype: str, date_start: str, hour: str):
    date = datetime.date.fromisoformat(date_start)
    settings = {
...
def download_data(date: str, levtype: str, hour: str):
    ...
    with tempfile.NamedTemporaryFile() as f:
        ...
        server.retrieve(dataset, settings, f.name)
